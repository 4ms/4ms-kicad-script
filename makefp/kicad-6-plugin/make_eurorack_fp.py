...
def make_faceplate_outline(board):
    ...
    railmount_topleft = pcbnew.wxPoint(int(topleft.x + 0.295*25.4*SCALE), int(topleft.y + 0.118*25.4*SCALE))
    railmount_topright = pcbnew.wxPoint(int(topright.x - 0.295*25.4*SCALE), int(topright.y + 0.118*25.4*SCALE))
    railmount_bottomleft = pcbnew.wxPoint(int(bottomleft.x + 0.295*25.4*SCALE), int(bottomleft.y - 0.118*25.4*SCALE))
    railmount_bottomright = pcbnew.wxPoint(int(bottomright.x - 0.295*25.4*SCALE), int(bottomright.y - 0.118*25.4*SCALE))
