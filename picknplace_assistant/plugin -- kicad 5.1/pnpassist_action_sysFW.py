...
# on dan's home laptop, using numpy from /usr/local/lib/python2.7/ works but matplotlib does not 
# sys.path.append('/usr/local/lib/python2.7/site-packages')

# on dan's home laptop, numpy and matplotlib both work from this dir:
